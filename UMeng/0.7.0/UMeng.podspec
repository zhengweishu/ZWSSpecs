...
all umeng related function are packaged here.
  ...
  s.source           = { :git => "https://github.com/zhengweishu/UMeng.git", :tag => "0.7.0" }
  ...
  s.subspec 'NetworkEngine' do |networkEngine|
    networkEngine.source_files = 'UMeng/Classes/NetworkEngine/*'
    networkEngine.dependency 'AFNetworking', '~> 2.3'
  end

  s.subspec 'DataModel' do |dataModel|
    dataModel.source_files = 'UMeng/Classes/DataModel/*'
    dataModel.dependency 'UMeng/NetworkEngine'
  end

  # s.public_header_files = 'UMeng/Classes/**/*.h'
